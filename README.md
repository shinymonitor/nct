...
- Flexibility: While NCT provides build.h as a starting point, your build script is just C. You have the full power of the language and are free to use any library you want, including more advanced build systems like [nob.h](https://github.com/tsoding/nob.h) or [construct.h](https://github.com/shinymonitor/construct.h). The .nct config files allow you to integrate any toolchain or workflow.
